...
- [ ] **EDU-04**: New PDF Guide Agent generates a branded mini-guide PDF (ReportLab, UncoverAI branding), uploads to GCS, returns public URL
- [ ] **EDU-05**: DM keyword auto-generated by LLM from the topic (e.g. "how to use Claude for work" → "CLAUDE"); max 8 chars, uppercase
